...
if __name__ == '__main__':
    ...
    predictor.initialize_from_trained_model_folder(
            join('/cbica/home/dongn/repos/nnUNet/nnUNet_results/Dataset902_TOFMNM/nnUNetTrainer__nnUNetPlans__2d'),
            use_folds=(0,),
            checkpoint_name='checkpoint_final.pth',
        )
    predictor.predict_from_files('/cbica/home/dongn/repos/nnUNet/nnUNet_raw/Dataset902_TOFMNM/imagesTs',
                                    '/cbica/home/dongn/repos/nnUNet/nnUNet_raw/Dataset902_TOFMNM/imagesPr',
                                    save_probabilities=False, overwrite=False,
                                    num_processes_preprocessing=2, num_processes_segmentation_export=2,
                                    num_parts=1, part_id=0)
